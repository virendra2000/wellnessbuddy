...
const Sidebar = () => {
    ...
    return (
        <>
            <div className="flex flex-row md:flex-col items-center justify-between h-auto md:min-h-screen w-full bg-orange-500 p-2 rounded-lg shadow-lg shadow-gray-500 dark:shadow-none">
